    ...
    <div class="wrapper" id="app">
      <div class="card-form">
        ...
        <div class="card-form__inner">
          ...
          <v-btn block color="secondary" large  class="font-weight-black rounded-lg" @click="sendData()">
...
<script>
  ...
  export default {
    ...
    mounted() {
      setTimeout(() => {
        window.Mercadopago.setPublishableKey('APP_USR-4eafc90c-0839-40ed-9866-89280087ed09'/*'APP_USR-5d6ea979-4790-47b1-8155-c3d48c89bc61'*/);
      }, 3000);
    ...
    methods: {
      ...
      async sendPaymentData({
        ...
        try {
          return this.$axios.post(this.$axios.defaults.baseURL +
              `/productos/impulsar/${this.$route.params.id_producto}`, {
                token,
                paymentMethod,
                installments,
              }).then(res => res)
