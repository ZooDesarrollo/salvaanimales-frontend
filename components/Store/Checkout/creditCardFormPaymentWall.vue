        ...
        <div class="card-form">
                ...
                <div class="card-item__wrapper">
                  ...
                  <div class="card-item__content">
                    <label for="cardName" class="card-item__info" ref="cardName">
                      <div class="card-item__holder font-weight-bold">PROPIETARIO</div>
                      <transition name="slide-fade-up">
                        ...
                        <div class="card-item__name font-weight-bold" v-else key="2">NOMBRE APELLIDO</div>
                      </transition>
                    </label>
                    <div class="card-item__date" ref="cardDate">
                      <label for="cardMonth" class="card-item__dateTitle font-weight-bold">VENCE</label>
                      <label for="cardMonth" class="card-item__dateItem">
                        <transition name="slide-fade-up font-weight-bold">
          ...
          <div class="card-form__inner">
            ...
            <div class="card-input">
              <label for="cardNumber" class="card-input__label font-weight-bold">Numero de la tarjeta</label>
              <input type="text" id="cardNumber" data-brick="card-number" class="card-input__input"
            ...
            <div class="card-input">
              <label for="cardName" class="card-input__label font-weight-bold">Nombre</label>
            ...
            <div class="card-form__row">
              <div class="card-form__col">
                <div class="card-form__group">
                  <label for="cardMonth" class="card-input__label font-weight-bold">Fecha de vencimiento</label>
                  <select class="card-input__input -select" id="cardMonth" v-model="cardMonth"
                    data-brick="card-expiration-month" v-on:focus="focusInput" v-on:blur="blurInput"
                    data-ref="cardDate">
                  ...
                  <select class="card-input__input -select" id="cardYear" v-model="cardYear"
                    data-brick="card-expiration-year" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardDate">
              ...
              <div class="card-form__col -cvv">
                <div class="card-input">
                  <label for="cardCvv" class="card-input__label font-weight-bold">CVV</label>
                  <input type="text" class="card-input__input" id="cardCvv" v-mask="'####'" data-brick="card-cvv"
            ...
            <v-btn color="primary" :loading="loading" class="font-weight-black card-form__button" @click="sendData()">
              PAGAR
            </v-btn>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    head() {
      return {
        script: [{
          src: "https://api.paymentwall.com/brick/build/brick-default.1.5.0.min.js"
        }]
      };
    },
    data() {
    ...
    methods: {
      sendData() {
        ...
        var $form = document.getElementById('brick-creditcard-form')
        var brick = new Brick({
          public_key: 't_afdea10ec5808417a5e3f0e6bb57ef', // please update it to Brick live key before launch your project
          form: {
            formatter: true
          }
        }, 'custom');
        ...
        brick.tokenizeCard({ // Tokenize payment details
          ...
          card_expiration_year: this.cardYear,
