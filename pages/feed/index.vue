<template>
  <v-container>
    <v-row>
      <v-col class="col-12">
        <v-card color="green lighten-1" height="70" elevation="12" class="d-flex align-center justify-space-between rounded-xl">
          <img :src="`/logo.png`" position="center left" height="70" width="70" contain>
          <h3 class="text-h6 font-weight-black text-center text-shadow white--text">FEED</h3>
